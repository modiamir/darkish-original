...
class SponsorTree
{
     ...
     * @Groups({"list", "details", "sponsor.details", "api.list"})
     */
    private $id;
     ...
     * @Groups({"list", "details", "sponsor.details"})
     */
    private $upTreeIndex;
    ...
    /**
     * @var \Doctrine\Common\Collections\ArrayCollection $sponsor
     *
     * @ORM\ManyToMany(targetEntity="Darkish\CategoryBundle\Entity\Sponsor", mappedBy="trees")
     */
    protected $sponsor;

    /**
     * @ORM\OneToMany(targetEntity="SponsorSponsorTree", mappedBy="tree")
     **/
     ...
     * @return SponsorTree
     */
    public function addSponsor(\Darkish\CategoryBundle\Entity\Sponsor $sponsor)
    {
     ...
     * @param \Darkish\CategoryBundle\Entity\Sponsor $sponsor
     */
    public function removeSponsor(\Darkish\CategoryBundle\Entity\Sponsor $sponsor)
    {
     ...
     * Add mainsponsors
     *
     * @param \Darkish\CategoryBundle\Entity\SponsorSponsorTree $mainsponsors
     * @return SponsorTree
     */
    public function addMainsponsor(\Darkish\CategoryBundle\Entity\SponsorSponsorTree $mainsponsors)
    {
     ...
     * @param \Darkish\CategoryBundle\Entity\SponsorSponsorTree $mainsponsors
     */
    public function removeMainsponsor(\Darkish\CategoryBundle\Entity\SponsorSponsorTree $mainsponsors)
    {
        $this->mainsponsors->removeElement($mainsponsors);
    }
