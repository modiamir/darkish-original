...
<!--                        <button class="btn btn-info add-attachment" ng-disabled="!ClassifiedService.isEditing()" data-ng-click="showUploadModal()">
        ...
        <div class="row list">
            <div class="col col-lg-12 grid-block-wrapper">
                ...
                {{classifiedList().length}} از
                {{ClassifiedService.totalClassified}}
                </h4>
    ...
    <div  class="classified-top show-grid ">
        ...
        <div class="col-xs-4">
            ...
            <div ng-show="SecurityService.buttonsAccess.deleteButtonAccess()" style="display: inline-block; margin: 0" class="dropdown">
              <button ng-disabled="!ClassifiedService.currentClassified.id || ClassifiedService.isEditing() || !SecurityService.connected" class="btn btn-danger btn-xs dropdown-toggle" type="button" id="claimtypedropdowm" data-toggle="dropdown" aria-expanded="true" style="line-height: inherit">
                حذف
