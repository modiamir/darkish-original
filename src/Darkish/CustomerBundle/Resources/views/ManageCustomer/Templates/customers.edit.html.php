...
<!--<a ui-sref="customers" class="btn btn-default btn-xs">بازگشت</a>-->
<div class="btn-group">
    <button ui-sref="customers" type="button" class="btn btn-default" aria-label="Right Align">
        بازگشت
    </button>
    <button ng-disabled="!customerEdit.$valid" type="submit" ng-click="submit()" class="btn btn-success">ذخیره</button>
        ...
        <div class="row">
            <div class="col col-md-4 right">
                <div class="form-group">
                    ...
                    <input ng-disabled="true" ng-model="customer.username" type="email" class="form-control" id="customerUsername" placeholder="نام کاربری">
                </div>
                
                <div class="form-group">
                    <label for="customerPassword">رمز عبور</label>
                    <input ng-pattern="/^(?=.*[0-9]+.*)(?=.*[a-zA-Z]+.*)[0-9a-zA-Z]{6,}$/" name="customerPassword" ng-model="customer.newPassword" type="password" class="form-control" id="customerPassword" placeholder="رمز عبور">
                </div>
                <div class="form-group">
                    <label for="customerPasswordConfirm">تکرار رمز عبور</label>
                    <input  name="customerPasswordConfirm" match="customer.newPassword" ng-model="customer.new_password_confirm" type="password" class="form-control" id="customerPasswordConfirm" placeholder="تکرار رمز عبور">
