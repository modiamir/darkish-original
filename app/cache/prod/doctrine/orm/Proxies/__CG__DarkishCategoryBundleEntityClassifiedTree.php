 ...
 */
class ClassifiedTree extends \Darkish\CategoryBundle\Entity\ClassifiedTree implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'id', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'upTreeIndex', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'treeIndex', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'sort', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'title', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'subTitle', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'backKeyTitle', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'searchKeywords', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'showSubtreeAsFilter', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'showSponsorBox', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'sponsorGroup', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'iconFileName', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'iconSetFilesName', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'fontColor', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'backColor', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'subPicShow', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'subBackground', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'subUnitHeightScale', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\ClassifiedTree' . "\0" . 'hiddenTree');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClassifiedTree $proxy) {
