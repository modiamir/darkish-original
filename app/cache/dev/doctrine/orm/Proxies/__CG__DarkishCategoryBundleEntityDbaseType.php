 ...
 */
class DbaseType extends \Darkish\CategoryBundle\Entity\DbaseType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\DbaseType' . "\0" . 'id', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\DbaseType' . "\0" . 'name', 'records');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DbaseType $proxy) {
