 ...
 */
class Area extends \Darkish\CategoryBundle\Entity\Area implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\Area' . "\0" . 'id', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\Area' . "\0" . 'name', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\Area' . "\0" . 'longitude', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\Area' . "\0" . 'latitude', '' . "\0" . 'Darkish\\CategoryBundle\\Entity\\Area' . "\0" . 'sort', 'records');
        }
